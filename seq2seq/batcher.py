from data_process.data_loader import load_train_dataset, load_test_dataset
import tensorflow as tf


def train_batch_generator(batch_size, max_enc_len=400, max_dec_len=60, sample_sum=None):
    # 加载数据集
